...
import { CreditCard, Package, Zap, Settings as SettingsIcon, Calendar } from 'lucide-react';
...
interface SubscriptionPlan {
  ...
  ai_leave_approval: boolean;
  ai_anomaly_detection: boolean;
  ai_payroll_error_detection: boolean;
  ...
  useEffect(() => {
    if (plan) {
      setFormData({
        ...
        pricing_annual: plan.pricing_annual,
        currency: plan.currency,
        per_employee: plan.per_employee,
        ...
        ai_leave_approval: plan.ai_leave_approval,
        ai_anomaly_detection: plan.ai_anomaly_detection,
        ai_payroll_error_detection: plan.ai_payroll_error_detection,
        custom_reports: plan.custom_reports,
      ...
      <ModalContent>
        ...
        <ModalBody>
          ...
          >
            ...
            >
              <div className="space-y-4 py-4">
                <div className="p-3 rounded-lg bg-gray-50 dark:bg-gray-800">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Slug (read-only)</p>
                  <p className="text-sm font-mono font-semibold">{plan.slug}</p>
                </div>
            ...
            {/* Limits Tab - Same as Create Modal */}
            <Tab
              key="limits"
              title={
                <div className="flex items-center gap-2">
            ...
            {/* Features Tab - Similar to Create, shortened for brevity */}
            <Tab
              key="features"
              title={
                <div className="flex items-center gap-2">
